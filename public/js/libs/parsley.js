  ...
  ParsleyField.prototype = {
      ...
      for ( var constraint in this.constraints ) {
        ...
        if ( false === result ) {
          ...
          if (false === this.options.listeners.onFieldSuccess( this.element, this.constraints, this )) {
            valid = false;
          } else if (this.options.errors.validHandler) {
              this.options.errors.validHandler(this.element);
          }
        }
      }
    ...
    */
    , manageError: function ( constraint ) {
      ...
      if (this.options.errors.errorHandler) {
          this.options.errors.errorHandler(this.element, message);
      }
